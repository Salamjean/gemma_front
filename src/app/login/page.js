    ...
    try {
      ...
      if (response.ok) {
        Swal.fire({
          ...
          text: data.message || 'Le code de vérification a été envoyé par SMS/Email.',
        ...
        const errorMessage = data.message || 'Identifiant invalide ou non trouvé.';
        Swal.fire({
            icon: 'error',
    ...
    <div className="relative flex min-h-screen items-center justify-center p-4 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
            <Image
                ...
                quality={80}
            />
            <div className={`absolute inset-0 opacity-80`} style={{ backgroundColor: 'gray', opacity: 0.5 }}></div> 
        </div>
        ...
        <div className="w-full max-w-lg p-10 space-y-8 bg-white shadow-2xl rounded-2xl border border-gray-100 relative z-10">
          ...
          <div className="text-center">
              <FaUserShield className={`mx-auto text-6xl mb-4`} style={{ color: PRIMARY_BLUE }} />
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="code" className={`block text-sm font-semibold mb-1`} style={{ color: PRIMARY_BLUE }}>
                Votre DM ...
              </label>
              <input
                id="code"
          ...
          <div className="text-center text-sm pt-2">
              <p className="text-gray-500">
                  <Link href="/" className={`font-medium hover:opacity-80 transition duration-200`} style={{ color: PRIMARY_BLUE }}>
                      Retour - accueil
                  </Link>
              </p>
          </div>
