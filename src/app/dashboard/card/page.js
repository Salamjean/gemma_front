      ...
      <div className="p-4 md:p-6">
        ...
        {loading && !patient ? (
             <div className="flex justify-center items-center h-64">
                ...
                <FaSpinner className="animate-spin text-4xl mb-4 mx-auto" style={{ color: PRIMARY_BLUE }} />
            ...
            <div className="flex flex-col items-center justify-center min-h-[500px] bg-white rounded-xl border border-gray-100 p-8 shadow-sm">
                ...
                <div className="mt-8 text-center max-w-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">À propos de votre carte</h3>
                    <p className="text-sm text-gray-500">
                        Cette carte est personnelle et contient vos informations médicales essentielles.
                        Présentez-la lors de vos consultations pour un accès rapide à votre dossier.
                        En cas de perte, veuillez contacter l'administration de votre établissement.
                    </p>
                </div>
            </div>
        ) : (
            <div className="text-center p-8 bg-red-50 rounded-xl border border-red-100">
                <p className="text-red-600 font-medium">Impossible de charger les informations de votre carte.</p>
                <button 
