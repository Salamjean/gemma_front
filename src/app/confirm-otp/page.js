...
function ConfirmOtpContent() {
  ...
  if (!identifier) {
    return (
      <div className="flex min-h-screen items-center justify-center text-primary-blue" style={{ color: PRIMARY_BLUE }}>
    ...
    <div className="relative flex min-h-screen items-center justify-center p-4 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
            <Image
                ...
                quality={80}
            />
            <div className={`absolute inset-0 opacity-50`} style={{ backgroundColor: "gray" }}></div> 
        </div>
        ...
        <div className="w-full max-w-lg p-10 space-y-8 bg-white shadow-2xl rounded-2xl border border-gray-100 relative z-10">
          ...
          <div className="text-center">
              <FaUnlockAlt className={`mx-auto text-6xl mb-4`} style={{ color: PRIMARY_BLUE }} />
              <h2 className={`text-4xl font-extrabold`} style={{ color: PRIMARY_BLUE }}>
                Vérification OTP
              </h2>
              <p className="mt-2 text-gray-500 text-lg">
                  Veuillez entrer le code à 6 chiffres envoyé à partir du DM <span className="font-bold" style={{ color: ACCENT_GREEN }}>{identifier}</span>.
              </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="otp" className={`block text-sm font-semibold mb-1`} style={{ color: PRIMARY_BLUE }}>
          ...
          <div className="space-y-3 pt-2 text-center">
              ...
              <button 
                ...
                className={`w-full flex items-center justify-center text-sm font-medium transition duration-200 ${countdown > 0 ? 'text-gray-400 cursor-not-allowed' : 'hover:opacity-80'}`}
              ...
              <p className="text-sm text-gray-500">
                  <span onClick={() => router.push('/login')} className={`font-medium cursor-pointer hover:opacity-80 transition duration-200`} style={{ color: PRIMARY_BLUE }}>
